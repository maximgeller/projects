...
Cool, so you might already be able to see how this plays into the theorem. Bayes Theorem says that the probability that A is true given B 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNjI3NjM1OTgsMTU4OTg1NTU0NiwtMz
